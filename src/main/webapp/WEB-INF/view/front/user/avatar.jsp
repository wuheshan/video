        ...
        <div class="container">
            ...
            <div id="profile_tab">
               <ul class="profile_tab_header f_left clearfix">
                     <li><a href="/zy_video/user/profile.action?id=${user.id}">更改资料</a></li>
                    	<li class="profile_tab_line">|</li>
                    	<li><a href="/zy_video/user/avatar.action?id=${user.id}">更改头像</a></li>
                    	<li class="profile_tab_line">|</li>
                    	<li><a href="/zy_video/user/password.action?id=${user.id}">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        ...
                        <div class="profile_ifo_area">
                            <form id="upload_form" enctype="multipart/form-data" method="post" action="/zy_video/user/updateHeadPic.action?id=${user.id}" >
                                <p>请选择图像文件</p>
                                <div>
